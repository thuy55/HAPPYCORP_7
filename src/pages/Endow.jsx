...
const EndowPage = () => {
    ...
    return (
     ...
     <CommonNavbar />
                    ...
                    <div className="row " onClick={() => { handleClick(1) }}>
                        ...
                        <div className='col-8 ps-0 fs-13'>
                            ...
                            <div className='d-flex justify-content-end mt-1'>
                                <button className=' p-1 px-3 rounded-3 border-btn'>Xem ngay</button>
                            </div>
                        </div>
                    </div>
                </Card>
            ...
            <div className='row d-flex flex-nowrap mx-2 mt-2 pb-2 mb-4' style={{ overflowX: "auto", whiteSpace: "nowrap" }}>
